  ...
  return (
    <div>
      ...
      <div className="absolute">
        <img className="min-h-screen w-screen object-cover "
          src={BG_IMG}
          alt=""
        />
      </div>
      ...
      <form
        ...
        className="absolute text-white  bg-black p-10 md:p-10  md:w-3/12 my-24 md:my-30 mx-2 md:mx-auto left-0 right-0 bg-opacity-80 "
      >
